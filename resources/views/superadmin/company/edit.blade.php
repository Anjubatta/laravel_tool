  ...
  <div class="col-md-8">
    <div class="tile">
       <div class="tile-title green">
          <h3>{{ $title['title'] }}</h3>
          <a href="{{ route('superadmin.company.index') }}" class="btn btn-outline-warning table_top_btn"><i class="fa fa-arrow-left"></i> Back</i></a>
      </div>

        {!! Form::model($company, ['route' => ['superadmin.company.update', $company->id], 'method' => 'PATCH']) !!}
          <div class="tile-body">

            @include('superadmin.company.partials.form')
