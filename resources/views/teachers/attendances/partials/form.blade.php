<div class="form-group row">
	...
	<label>Time In</label>
	   {!! Form::text('timein', @$data->timein, ['class' => 'form-control'. ($errors->has('timein') ? ' is-invalid' : ''),'placeholder'=>"Time In" ]) !!}
		{!! $errors->first('timein', '<span class="help-block">:message</span>') !!}
    </div>
  
    <div class="col-sm-10 col-lg-6 col-md-6">     
	<label>Time Out</label>
	   {!! Form::text('timeout', @$data->timeout, ['class' => 'form-control'. ($errors->has('timeout') ? ' is-invalid' : ''),'placeholder'=>"Time Out" ]) !!}
