...
<!---------------- new css ----------------------->
            ...
            <h2 class="heading heading2"><span>Personal Informations</span></h2>
              ...
              <div class="form-row">
               ...
               <div class="form-row">
                <div class="form-group col-md-8">
                  <h4>Address:</h4>
                  <input class="disable_addr" type="text" disabled="disabled"  value="{{ $student->address }}">
                </div>
              </div>    
            </div>
            ...
            <section class="personal">
            <h2 class="heading heading2"><span>Attendance and Temperature</span></h2>
            <div class="personal_data">
                 <div class="form-row">
                <div class="form-group col-sm-12  col-xs-12 col-md-6 col-lg-4">
                  <h4>Expected Attendance:</h4>
                  <input type="text" value="{{$company->expected_attendance}}">
                </div>
                <div class="form-group col-sm-12  col-xs-12 col-md-6 col-lg-4">
                 <h4>Present:</h4>
               ...
               <div class="form-row">
                ...
                <div class="form-group col-sm-12  col-xs-12 col-md-6 col-lg-4">
                 <h4>Absent:</h4>
                  <input type="text" value="{{$absent}}">
                </div>
              </div>
               <div class="form-row">
                <div class="form-group col-sm-12  col-xs-12 col-md-6 col-lg-4">
                  <h4>High Temperature:</h4>
                  <input type="text" value="{{$highTemp}}">
                </div>
                <div class="form-group col-sm-12  col-xs-12 col-md-6 col-lg-4">
        ...
        <section class="personal">
            <h2 class="heading heading2"><span>Parent Particular:</span></h2>
            <div class="personal_data">
